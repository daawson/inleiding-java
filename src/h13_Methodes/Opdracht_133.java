        ...
        if(drawMeABrick){
            for(int x = 0; x < wallWidth*2; x++){
                for(int y = 0; y < wallHeight*2; y++){
                    if(y % 2 == 0)
                        Helper.drawWall(g, Color.red, 30+x*30, 50+y*15, 30, 15);
                    else
                        Helper.drawWall(g, Color.red, 15+x*30, 50+y*15, 30, 15);
                }
            }
        }
            ...
            for(int x = 0; x < wallWidth; x++){
                for(int y = 0; y < wallHeight; y++){
                    if(y % 2 == 0)
                        Helper.drawWall(g, Color.gray, 50+x*50, 50+y*25, 50, 25);
                    else
                        Helper.drawWall(g, Color.gray, 25+x*50, 50+y*25, 50, 25);
                }
            }
        }
    }
